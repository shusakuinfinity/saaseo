            ...
            <section className="py-16 bg-white">
                <div className="container px-4 mx-auto">
                    <div className="max-w-lg mx-auto text-center">
                        <span className="inline-block py-1 px-3 text-xs md:text-sm rounded-xl bg-blue-50 text-blue-600 font-semibold">404 / Not Found</span>
                        <h1 className="my-3 text-3xl md:text-4xl font-bold font-heading text-blueGray-900">お探しのページが見つかりませんでした</h1>
                        <p className="text-blueGray-400 leading-relaxed">以下のメニューよりご希望のページにお戻りください</p>
                        <div className="py-8">
