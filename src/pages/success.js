            ...
            <section className="py-16 bg-white">
                <div className="container px-4 mx-auto">
                    <div className="max-w-lg mx-auto text-center">
                        ...
                        <h2 className="my-3 text-3xl md:text-4xl font-bold font-heading text-blueGray-900">内容が無事送信されました</h2>
                        <p className="text-blueGray-400 leading-relaxed">1-3営業日以内にメールにてご返信致します。メールアドレスの打ち間違い等で返信ができない可能性がございますので、返信が来ていない場合はお手数をおかけしますが<span className="text-blue-600"><a href="mailto:contact@saaseo.com">contact@saaseo.com</a></span>までご連絡ください。</p>
                        <div className="py-8">
