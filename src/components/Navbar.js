            ...
            <section className="bg-blueGray-800"><div className="container px-4 mx-auto">
                <nav className="flex justify-between items-center lg:py-4 py-3">
                    ...
                    <div className="hidden lg:block">
                        <Link className="inline-block px-4 py-3 text-xs font-semibold leading-none text-blueGray-500 hover:text-blueGray-600 text-center bg-white border border-blueGray-200 hover:border-blueGray-300 rounded transform hover:-translate-y-1 duration-200 hover:shadow-xl" to="/contact">お問い合わせ</Link>
                    </div>
                </nav>
                <div className={show ? "navbar-menu fixed top-0 right-0 bottom-0 w-5/6 max-w-sm z-50" : "hidden"}>
                    ...
                    <nav className="relative flex flex-col py-6 px-6 w-full h-full bg-white border-r overflow-y-auto"><div className="flex items-center mb-8">
                        ...
                        <button onClick={() => { setShow(!show) }} className="navbar-close ml-auto">
                        ...
                        <div>
                            <ul><li className="mb-1"><Link className="block p-4 text-center text-sm text-blueGray-500 hover:bg-yellow-50 hover:text-yellow-600" to="/first-timer">初めての方へ</Link></li>
                                <li className="mb-1"><Link className="block p-4 text-center text-sm text-blueGray-500 hover:bg-yellow-50 hover:text-yellow-600" to="/seo">SEO対策</Link></li>
                                <li className="mb-1"><Link className="block p-4 text-center text-sm text-blueGray-500 hover:bg-yellow-50 hover:text-yellow-600" to="/responsive">スマホ対応</Link></li>
                                <li className="mb-1"><Link className="block p-4 text-center text-sm text-blueGray-500 hover:bg-yellow-50 hover:text-yellow-600" to="/saas">SaaS導入</Link></li>
                                <li className="mb-1"><Link className="block p-4 text-center text-sm text-blueGray-500 hover:bg-yellow-50 hover:text-yellow-600" to="/blazing-fast">爆速サイト</Link></li>
                                <li className="mb-1"><Link className="block p-4 text-center text-sm text-blueGray-500 hover:bg-yellow-50 hover:text-yellow-600" to="/about-us">会社案内</Link></li>
                                <li className="mb-1"><Link className="block p-4 text-center text-sm text-blueGray-500 hover:bg-yellow-50 hover:text-yellow-600" to="/subsidy">補助金について</Link></li>
                            </ul>
                            <div className="mt-4 pt-6 border-t border-blueGray-100">
                                <Link className="block px-4 py-3 mb-3 text-xs text-center font-semibold leading-none bg-blue-600 hover:bg-blue-700 text-white rounded" to="/contact">お問い合わせ</Link>
                            </div>
                        </div>
