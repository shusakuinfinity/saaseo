        ...
        <section className="py-16 bg-blueGray-800"><div className="container px-4 mx-auto">
            <div className="flex flex-col mb-10">
                ...
                <ul className="py-2 flex lg:flex-row items-center justify-center space-x-12 text-white">
                    ...
                    <li><Link activeClassName="text-blueGray-400" className="font-bold font-heading hover:text-yellow-200 duration-200 transition text-sm md:text-lg" to="/privacy">プライバシー・ポリシー</Link></li>
                </ul>
            </div>
